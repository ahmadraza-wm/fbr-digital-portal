...
const assign_per = computed(() => userPermissions.value.assigned_permissions || [])

console.log('assign permissions', userPermissions.value.assigned_permissions);
...
const revokePermissions = async () => {
  ...
  try {
    const response = await $axios.patch(`/permissions/revoke/${props.userId}`, {
  ...
  <VCard>
    ...
    <VCardText class="px-4 pt-4 pb-4">
      <VRow>
        ...
        <VCol cols="12" class="d-flex justify-end" v-if="permissionStore.hasPermission('permissions.revoke')">
