...
export const useCustomerDocumentExport = () => {
    const {
        loading,
        showLoading,
        hideLoading,
    ...
    const exportCustomerDocument = async (filters = {}) => {
        showLoading("Exporting customer documents...");
        try {
            const response = await $axios.post(`/customer/documents/export`, filters, {
                responseType: "text",
                headers: { Accept: "application/json, text/csv" },
            });
            const contentType = response.headers["content-type"] || "text/csv";
            let fileName = "customer_document_export.csv";
            ...
            showSuccess("Customer  Document exported successfully.");
        }
        catch (error) {
