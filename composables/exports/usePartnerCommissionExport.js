...
export const usePartnerCommissionExport = () => {
    const {
        loading,
        showLoading,
        hideLoading,
    ...
    const exportPartnerCommission = async (filters = {}) => {
        showLoading("Exporting partner commission report..");
        try {
            const response = await $axios.post(`/partner/commission/export`, filters, {
                responseType: "text",
                headers: { Accept: "application/json, text/csv" },
            });
            const contentType = response.headers["content-type"] || "text/csv";
            let fileName = "partner_commission_export.csv";
            ...
            showSuccess("Partner Commission report exported successfully.");
        }
        catch (error) {
